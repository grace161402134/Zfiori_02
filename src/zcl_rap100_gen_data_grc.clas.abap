CLASS zcl_rap100_gen_data_grc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_GRC IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap_atrav_grc02.
*    DELETE FROM zrap_atrav_grc02.

    "insert travel demo data
    INSERT zrap_atrav_grc02  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zrap_atrav_grc02{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
